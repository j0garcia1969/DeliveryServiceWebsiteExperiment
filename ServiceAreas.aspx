<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ServiceAreas.aspx.cs" Inherits="_Default" %>
...
<body>
   <form id="form1" runat="server">
      ...
      <div class="relative">
         ...
         <div class="absoluter">
            <h4 id="toenlarge" style="color: lawngreen; height: 21px; text-align: center;">The Service You Can Trust
            </h4>
            <p id="tocolorred" style="color: saddlebrown;">Enjoy a 1-to-1 relationship with your very own Vermont Delivery Service, who delivers for you each time and learns your preferences</p>
            <p id="tocolorred2" style="color: saddlebrown;">Get your favorite products from store of your preference and get delivered right to your door</p>
            <p id="tocolorred3" style="color: saddlebrown;">We offer a range of other services including Medical deliveries, Legal courier deliveries, etc</p>
            <p id="tocolorred4" style="color: saddlebrown;">It's all backed by our 100% Stress-Free Gaurantee</p>
